...
function Build-Project()
{
    ...
    . $unityPath -quit -batchmode -projectpath $ProjectPath -$TargetPlatform $BuildPath -logFile $windowsLogPath | Out-Default
...
#Build For Windows
Build-Project -ProjectPath $ProjectPath -buildPath $windowsBuildPath -logFilePath $windowsLogPath -targetPlatform "buildWindows64Player" -gameName $gameName

# Build For Linux
Build-Project -ProjectPath $ProjectPath -buildPath $linuxBuildPath -logFilePath $linuxLogPath -targetPlatform "buildLinux64Player" -gameName $gameName
