...
public class InputEvent
{
    ...
    private static readonly Dictionary<InputAction, InputAction> _editorToGameplayActions = new()
    {
        ...
        { InputAction.Editor_NoteLeft, InputAction.Left },
        { InputAction.Editor_NoteRight, InputAction.Right },
        { InputAction.Editor_NoteUp, InputAction.Up },
        { InputAction.Editor_NoteDown, InputAction.Down },
