...
{
	private static Dictionary<Difficulty, double[]> _npsPerDifficulty = new()
    {
		...
		{ Difficulty.Hard, new double[] {		0.00, 0.000, 0.000, 1.005, 1.305, 1.605, 2.005, 2.605, 2.806, 3.305, 3.705, 4.505, 5.105 } },
